 ...
 <header>
	...
	<div class="main_div">
		...
		<form action="/employeeregister" method="post">
			<div class="input_box">
				  <input type="text" name="loginid" value="${loginid}" placeholder="Email_ID"/ required="required">
				<div class="icon">
					<i class="fas fa-user"></i>
				</div>
			</div>
			<div class="input_box">
				  <input type="text" name="loginid" value="${loginid}" placeholder="Name"/ required="required">
				<div class="icon">
					<i class="fas fa-user"></i>
				</div>
			</div>
			<div class="input_box">
				  <input type="password" name="password" value="${password}" placeholder="salary"/ required="required">
				<div class="icon">
			...
			<span style="color: red;" th:if="${employeeNotFound}">${errorMessage}</span>
