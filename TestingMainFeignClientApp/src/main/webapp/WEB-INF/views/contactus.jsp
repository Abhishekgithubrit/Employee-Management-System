    ...
    <div class="content">
      <div class="left-side">
        <div class="address details">
          ...
          <div class="text-one">GovindPuram</div>
          <div class="text-two">Ghaziabad</div>
        </div>
        ...
        <div class="email details">
          ...
          <div class="text-one">abhishekchatruvedi@.com</div>
          <div class="text-two">info.abhishekchatruvedi.com</div>
        </div>
      </div>
